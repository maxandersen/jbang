...
== Exporting apps [EXPERIMENTAL]

If you want the generated jar or native binary you can use `jbang export <script>` to get it copied (exported)
for you to use directly.

Note, the default generated jar will have classpath references that are machine dependent. If you want a portable
